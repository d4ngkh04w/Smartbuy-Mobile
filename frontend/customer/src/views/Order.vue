			...
			<form @submit.prevent="nextStep">
				<div>
					...
					<div
						...
						:class="{ 'disabled-item': !product.isActive }"
					>
						<img
							:src="productService.getUrlImage(product.imagePath)"
							alt="product"
						/>
			...
			.then((response) => {
				...
				Promise.all(
					orderData.items.map((item) =>
						productService.checkQuantityToToggleStatus(
							item.productId
						)
					)
				).then(() => {
