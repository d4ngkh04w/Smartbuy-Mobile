	...
	<div class="product-management">
		...
		<div v-if="showDetailModal" class="modal-backdrop">
			<div class="modal-container detail-modal">
					...
					<div v-if="selectedProduct" class="product-detail-content">
						...
						<div class="product-detail-header">
							<div class="product-detail-image">
								<img
									v-if="getProductMainImage(selectedProduct)"
							...
							<div class="product-detail-basic">
								...
								<div class="product-detail-info-row">
									...
									>
									<span class="detail-value">{{
										selectedProduct.productLineName
									}}</span>
								</div>
								<div class="product-detail-info-row">
						...
						>
							...
							<div class="specs-grid">
								<div
									v-if="selectedProduct.detail.ram"
									class="spec-item"
								>
									...
									<div class="spec-value">
										{{ selectedProduct.detail.ram }} GB
									</div>
								</div>
								<div
									v-if="selectedProduct.detail.storage"
									class="spec-item"
								>
									<div class="spec-label">
									...
									<div class="spec-value">
										{{ selectedProduct.detail.storage }} GB
									</div>
								</div>
								<div
									v-if="selectedProduct.detail.screenSize"
									class="spec-item"
								>
									<div class="spec-label">
										<i class="fas fa-mobile-alt"></i> Kích
										thước màn hình
									</div>
									<div class="spec-value">
										{{
								...
								<div
									v-if="
										selectedProduct.detail.screenResolution
									"
									class="spec-item"
								>
									<div class="spec-label">
										<i class="fas fa-expand"></i> Độ phân
										giải
									</div>
									<div class="spec-value">
										{{
								...
								<div
									v-if="selectedProduct.detail.battery"
									class="spec-item"
								>
									<div class="spec-label">
									...
									<div class="spec-value">
										{{ selectedProduct.detail.battery }} mAh
									</div>
								</div>
								<div
									v-if="selectedProduct.detail.processor"
									class="spec-item"
								>
									<div class="spec-label">
										<i class="fas fa-microchip"></i> Chip xử
										lý
									</div>
									<div class="spec-value">
										{{ selectedProduct.detail.processor }}
									</div>
								</div>
								<div
									v-if="
										selectedProduct.detail.operatingSystem
									"
									class="spec-item"
								>
									<div class="spec-label">
								...
								<div
									v-if="selectedProduct.detail.warranty"
									class="spec-item"
								>
									<div class="spec-label">
										<i class="fas fa-shield-alt"></i> Bảo
										hành
									</div>
									<div class="spec-value">
										{{
								...
								<div
									v-if="selectedProduct.detail.simSlots"
									class="spec-item"
								>
									<div class="spec-label">
										<i class="fas fa-sim-card"></i> Số khe
										SIM
									</div>
									<div class="spec-value">
										{{ selectedProduct.detail.simSlots }}
									</div>
								</div>
							</div>
						</div>
				...
				<div class="modal-actions">
					<button @click="closeDetailModal" class="cancel-button">
						<i class="fas fa-times"></i>
					</button>
				</div>
			</div>
...
.modal-body {
	padding: 1.5rem;
	overflow-y: auto;
	max-height: calc(90vh - 120px); /* Trừ đi chiều cao của header và footer */
	background-color: #f9f9f9;
}
...
.color-name {
	...
	gap: 0.5rem;
	font-weight: 500;
	background-color: rgba(248, 110, 211, 0.08);
	padding: 0.5rem 1rem;
	border-radius: 6px;
}
...
.main-image-badge {
	...
	left: 0;
	right: 0;
	background: linear-gradient(to right, var(--primary-color), #ff86d5);
	color: white;
	text-align: center;
	font-size: 0.75rem;
	padding: 0.3rem;
